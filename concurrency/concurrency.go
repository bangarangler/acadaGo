...
func main() {
	...
	x := make(chan int)
	y := make(chan int)
	// buffer channel (will do 3 on 4 will wait until one has been read)
	...
	// 	sum += num
	// 	i++
	// 	// manually close channel from outside
	// 	if i == 4 {
	// 		close(c)
	// 	}
	// }
...
//
// 	// don't care about the data from channel send it to the void (super basic)
// 	// <-channel1
// 	// <-channel2
// 	<-channel
// 	<-channel
...
// }
//
// func storeData(storableText, fileName string) {
